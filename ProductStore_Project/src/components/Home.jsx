...
function Home() {
    ...
    return filter && filter.length > 0 ? (
        <>
            <Navbar />
            <div className="Home w-full h-screen bg-slate-500 overflow-hidden">
                <div className="Cards w-[100%] pb-24  h-full m-5 mt-20 flex gap-5 flex-wrap justify-start overflow-y-auto overflow-x-hidden">
                    {filter.map((p) => (
