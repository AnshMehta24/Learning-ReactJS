   ...
   <div className="w-full h-screen duration-200" style ={{backgroundColor : color}}>
    <div className="fixed flex flex-wrap justify-center bottom-12  inset-x-0 px-2">
      <div className="flex flex-wrap justify-center gap-3 shadow-lg bg-white px-3 py-2 rounded-xl">
        ...
        <button className="outline-none px-4   py-1 rounded-full text-white shadow-sm" style={{backgroundColor : "aqua"}}onClick={()=>{setColor("aqua")}}>Aqua</button>
        ...
        <button className="outline-none px-4   py-1 rounded-full text-white shadow-sm" style={{backgroundColor : "darkmagenta"}}onClick={()=>{setColor("darkmagenta")}}>darkmagenta</button>
